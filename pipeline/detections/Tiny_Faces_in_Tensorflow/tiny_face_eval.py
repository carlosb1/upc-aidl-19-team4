...
def detect(sess, model, filename, average_image, clusters, clusters_h, clusters_w, normal_idx, score_final, x, prob_thresh=0.5, nms_thresh=0.1):
    ...
    return refined_bboxes, total_time
